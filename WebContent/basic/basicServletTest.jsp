...
<body>
	...
	<h3>GET방식 요청하기1 ==> 링크방식</h3>
	<a href="http://localhost/webTest/servletTest03.do">Get방식 요청1</a>
	<hr>
	
	<h3>GEt방식 요청하기2 ==> form태그의 methord속성 이용</h3>
<!--  
	<form> 태그의 method속성이 생략되거나 emthod='get'으로 설정하면 GET방식으로 요청된다.
-->
	...
	<hr>
	<h3>POST방식 요청 ==> form태그의 emthod속성에 속성값을 post로 설정</h3>
