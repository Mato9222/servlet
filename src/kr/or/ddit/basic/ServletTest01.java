...
/*
	서블릿이란? == > 컨테이너에 의해 간리되는 자바기반 웹 컴포넌트로써
...
/*
	이 예제는 배포 서술자(web.xml)를 이용해서 실행할 Servlet을 설정하는 예제이다.
*/
...
public class ServletTest01 extends HttpServlet{
	...
	// 이 영역에서는 service() 메서드또는 doGet()메서드나 doPost()메서드를
	// 재정의해서 작성한다.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.append("<html>")
			...
			.append("<title> 첫번쨰 Servlet연습</title>")
			.append("</head>")
			.append("<body>")
